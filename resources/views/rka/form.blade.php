...
@section('content')
    ...
    <div class="alert alert-info">
        ...
        <ul class="mb-0">
            <li>Pilih <strong>Bulan</strong> sesuai periode laporan. Bulan di masa depan otomatis nonaktif.</li>
            <li><strong>Kode Rekening</strong> bisa dikosongkan jika tidak ada.</li>
            <li><strong>Sub Uraian</strong> bisa dikosongkan jika tidak ada.</li>
            <li><strong>Mode Input</strong> Wajib di pilih mode total/detail per baris:
                <ul>
                    <li><strong>Detail</strong>: Isi <em>Jumlah</em> dan <em>Harga</em> dan pilih Satuan barangnya yang sudah di isi di bagian satuan barang, sistem akan menghitung
                        <em>Total</em>.
                    </li>
                    <li><strong>Total</strong>: Langsung isi <em>Total</em>, kolom Jumlah, Satuan, Harga dikunci.</li>
                </ul>
            </li>
            <li><strong>Saldo Awal</strong> akan mengatur mode, satuan, dan harga default untuk baris lainnya.</li>
            <li><strong>Beban Persediaan</strong> dihitung otomatis berdasarkan perhitungan saldo.</li>
        </ul>
    </div>
            ...
            12 => 'Desember',
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-8">
                            ...
                            <select name="kode_rekening_id" class="form-select">
                                ...
                                @foreach ($kodeRekenings as $kr)
                                    <option value="{{ $kr->id }}"
                                        {{ old('kode_rekening_id', $rka->kode_rekening_id) == $kr->id ? 'selected' : '' }}>
                                        {{ $kr->kode }} - {{ $kr->uraian }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-5">
                            ...
                            <input class="form-control" name="sub_uraian"
                                value="{{ old('sub_uraian', $rka->sub_uraian) }}">
                        </div>
                    </div>
